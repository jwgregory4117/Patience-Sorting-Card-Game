...
class Card(Comparable):
    """
    This class represents a Comparable playing Card,
    It is an immutable class.
    It inherits from Comparable, but number of compares are not kept.
    ...
    def compare(self, otherCard):
        ...
        if self.__rank > otherCard.__rank:
            return 1
        elif self.__rank < otherCard.__rank:
            return -1
        else:
            if self.__suit > otherCard.__suit:
                return 1
            elif self.__suit < otherCard.__suit:
                return -1
            else:
                return 0
    ...
    def __str__(self):
        ...
        card_string = ranks[self.__rank] + "-" + suits[self.__suit]
        return card_string
